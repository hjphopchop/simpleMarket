  ...
  return (
    <div>
      {totalCount ? (
        <div>
          {" "}
          <button className={cl.delete} onClick={onclearCart}>
            очистить корзину
          </button>
          ...
          <div className={cl.cartCostCount}>
            <div className={cl.totalCount}>Общее Количество: {totalCount}</div>
            <div className={cl.totalPrice}>Итог: {totalPrice}</div>
          </div>
        </div>
      ) : (
